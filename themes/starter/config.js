...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: '人间一趟，不过是个蹭饭的客人，还挑什么酸甜苦辣。', // 英雄区文字
  STARTER_HERO_TITLE_2: '欲买桂花同载酒，终不似，少年游', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  STARTER_HERO_BUTTON_1_TEXT: '开始阅读', // 英雄区按钮
  ...
  STARTER_FEATURE_TITLE: '生活', // 特性
  STARTER_FEATURE_TEXT_1: '谁的生活不是鸡零狗碎', // 特性
